    ...
    <div class="row gx-5 gx-xl-10 mb-xl-10">
        ...
        <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-center border-0 h-md-100 mb-5 mb-xl-10 shadow-sm">
            ...
            <div class="card-body d-flex align-items-center justify-content-start py-7 flex-column">
                <!--begin::Form-->
                <form id="form_leave" class="form w-100 pt-5" action="<?= base_url('submission_function/insert_leave'); ?>"  method="POST" enctype="multipart/form-data">
                    <!--begin::Scroll-->
                    <div class="d-flex flex-column me-n7 pe-7 pt-5" id="#">
                        ...
                        <div class="fv-row mb-7" id="req_date">
                            <!--begin::Label-->
                            <label class="required fw-semibold fs-6 mb-2">Tanggal Cuti</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                    ...
                    <div class="text-center pt-15">
                        <button type="button" id="submit_leave" onclick="submit_form(this,'#form_leave')" class="btn btn-primary">
        ...
        <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-center border-0 h-md-100 mb-5 mb-xl-10 shadow-sm">
            ...
            <div class="card-body pt-0 table-responsive">
                <!--begin::Table-->
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="table_leave" data-url="<?= base_url('table/leave'); ?>">
                    <thead>
                        <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-150px">Tanggal Cuti</th>
