    ...
    <div class="row gx-5 gx-xl-10 mb-xl-10">
        ...
        <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-center border-0 h-md-100 mb-5 mb-xl-10 shadow-sm">
            ...
            <div class="card-body d-flex align-items-center justify-content-start py-7 flex-column">
                <!--begin::Form-->
                <form id="form_permission" class="form w-100 pt-5" action="<?= base_url('submission_function/insert_permission'); ?>"  method="POST" enctype="multipart/form-data">
                    <!--begin::Scroll-->
                    <div class="d-flex flex-column me-n7 pe-7 pt-5" id="#">
                        ...
                        <div class="fv-row mb-7" id="req_type">
                            ...
                            <div class="input-group">
                                <select name="type" class="form-select form-select-solid" data-control="select2" data-placeholder="Pilih tipe">
                                    <option></option>
                                    <option value="1">Izin Keperluan</option>
                    ...
                    <div class="text-center pt-15">
                        <button type="button" id="submit_permission" onclick="submit_form(this,'#form_permission')" class="btn btn-primary">
        ...
        <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-center border-0 h-md-100 mb-5 mb-xl-10 shadow-sm">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                            ...
                            <div class="px-7 py-5">
                                ...
                                <div class="mb-5">
                                    ...
                                    <select id="filter_type" class="form-select form-select-solid filter-input table-filter" data-control="select2" data-placeholder="Pilih Tipe">
                                        <option value="all">Semua</option>
            ...
            <div class="card-body pt-0 table-responsive">
                <!--begin::Table-->
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="table_permission" data-url="<?= base_url('table/permission'); ?>">
                    <thead>
