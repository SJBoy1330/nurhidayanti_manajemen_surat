            ...
            <div class="row g-5 g-xl-10">
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-body table-responsive pt-0">
                        <!--begin::Table-->
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="table_category" data-url="<?= base_url('table/category'); ?>">
                            <thead>
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            ...
            <div class="modal-body mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                <form id="form_category" class="form" action="<?= base_url('master_function/tambah/category') ?>" method="POST" enctype="multipart/form-data">
                    <!--begin::Scroll-->
