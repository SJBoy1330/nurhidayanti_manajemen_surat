            ...
            <div class="row g-5 g-xl-10">
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-body table-responsive pt-0">
                        <!--begin::Table-->
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="table_admin" data-url="<?= base_url('table/admin'); ?>">
                            <thead>
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            ...
            <div class="modal-body mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                <form id="form_admin" class="form" action="<?= base_url('master_function/tambah/admin') ?>" method="POST" enctype="multipart/form-data">
                    <!--begin::Scroll-->
                    <div class="d-flex flex-column me-n7 pe-7" id="#">
                        ...
                        <div class="fv-row mb-7 d-flex justify-content-center align-items-center flex-column">
                            ...
                            <div class="image-input image-input-circle background-partisi" data-kt-image-input="true" style="background-image: url('<?= image_check('user.jpg','default') ?>')">
                                ...
                                <div id="display_image" class="image-input-wrapper w-200px h-200px background-partisi" style="background-image: url('<?= image_check('user.jpg','default') ?>')"></div>
