                ...
                <div class="card mb-5 mb-xl-8">
                    <div class="d-flex flex-stack flex-wrap ms-10 mt-10">
                        ...
                        <div class="page-title d-flex flex-column align-items-start">
                            <!--begin::Title-->
                            <h1 class="d-flex text-dark fw-bold m-0 fs-3">Data Petugas</h1>
                            <!--end::Title-->
                            <!--begin::Breadcrumb-->
                            <ul class="breadcrumb breadcrumb-dot fw-semibold text-gray-600 fs-7">
                                ...
                                <!--end::Item-->
                                <!--begin::Item-->
                                <li class="breadcrumb-item text-gray-600">Petugas</li>
                                <!--end::Item-->
                            </ul>
                            <!--end::Breadcrumb-->
                        </div>
                    ...
                    <div class="card-header border-0 pt-5">
                        ...
                        <div class="card-toolbar">
                            ...
                            <!--end::Toolbar-->
                            <!--begin::Add petugas-->
                             <button type="button" class="btn btn-sm btn-primary" onclick="tambah_data()" data-bs-toggle="modal" data-bs-target="#kt_modal_petugas">
                    ...
                    <div class="card-body table-responsive pt-0">
                        <!--begin::Table-->
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="table_petugas" data-url="<?= base_url('table/petugas'); ?>">
                            <thead>
                                <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                    <th class="min-w-10px pe-2" data-orderable="false" data-searchable="false">No</th>
                                    <th class="min-w-100px">Kode</th>
                                    <th class="min-w-200px">Data Petugas</th>
...
<div class="modal fade" id="kt_modal_petugas"  data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="title_modal" data-title="Edit Petugas|Tambah Petugas"></h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Tutup"></button>
            </div>
            <div class="modal-body mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                <form id="form_petugas" class="form" action="<?= base_url('master_function/tambah/petugas') ?>" method="POST" enctype="multipart/form-data">
                    <!--begin::Scroll-->
                    <div class="d-flex flex-column me-n7 pe-7" id="#">
                        ...
                        <div class="fv-row mb-7 d-flex justify-content-center align-items-center flex-column">
                            ...
                            <div class="image-input image-input-circle background-partisi" data-kt-image-input="true" style="background-image: url('<?= image_check('user.jpg','default') ?>')">
                                ...
                                <label class="btn btn-icon btn-circle btn-color-muted btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" data-bs-dismiss="click" title="Edit Data">
                                    ...
                                    <!--begin::Inputs-->
                                    <input type="file"  id="petugas_file" name="image" accept=".png, .jpg, .jpeg" />
                        ...
                        <!--begin::Input group-->
                        <div class="fv-row mb-7" id="req_username">
                            <!--begin::Label-->
                            <label class="required fw-semibold fs-6 mb-2">Username</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="username" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Masukkan Username" autocomplete="off" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                    ...
                    <div class="text-center pt-15">
                        <button type="button" id="submit_petugas" onclick="submit_form(this,'#form_petugas')" class="btn btn-primary">
